...
def test_work_notebook_runs() -> None:
    """Multiple Linear Regression in Statsmodels: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Multiple Linear Regression in Statsmodels: the folded-in exercise notebook is a valid notebook.
