...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-regression-model-validation/master/./images/new_overfit_underfit.png)
...
$r*{i,train} = y*{i,train} - \hat y_{i,train}$

$r*{i,test} = y*{i,test} - \hat y_{i,test}$
...
RMSE = $\sqrt{\frac{1}{n}\sum*{i=1}^{n}(y*{i} - \hat y_{i})^2}$
