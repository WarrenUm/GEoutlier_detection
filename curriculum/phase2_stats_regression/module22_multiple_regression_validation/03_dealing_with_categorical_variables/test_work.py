...
def test_work_notebook_runs() -> None:
    """Dealing with Categorical Variables: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Dealing with Categorical Variables: the folded-in exercise notebook is a valid notebook.
