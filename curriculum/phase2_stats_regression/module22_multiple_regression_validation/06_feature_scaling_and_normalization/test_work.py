...
def test_work_notebook_runs() -> None:
    """Feature Scaling and Normalization: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Feature Scaling and Normalization: the folded-in exercise notebook is a valid notebook.
