...
def test_work_notebook_runs() -> None:
    """Multiple Regression and Model Validation - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Multiple Regression and Model Validation - Introduction: the folded-in exercise notebook is a valid notebook.
