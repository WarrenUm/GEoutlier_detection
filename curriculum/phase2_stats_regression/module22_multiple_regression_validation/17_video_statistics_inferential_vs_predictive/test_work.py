...
def test_work_notebook_runs() -> None:
    """🎬 Video: Statistics: Inferential vs. Predictive: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: Statistics: Inferential vs. Predictive: the folded-in exercise notebook is a valid notebook.
