...
def test_work_notebook_runs() -> None:
    """Multicollinearity of Features: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Multicollinearity of Features: the folded-in exercise notebook is a valid notebook.
