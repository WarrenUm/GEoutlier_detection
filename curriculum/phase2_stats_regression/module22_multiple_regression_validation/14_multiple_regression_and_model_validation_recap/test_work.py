...
def test_work_notebook_runs() -> None:
    """Multiple Regression and Model Validation - Recap: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Multiple Regression and Model Validation - Recap: the folded-in exercise notebook is a valid notebook.
