...
def test_work_notebook_runs() -> None:
    """🎬 Video: Hypothesis Testing: z-Tests: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: Hypothesis Testing: z-Tests: the folded-in exercise notebook is a valid notebook.
