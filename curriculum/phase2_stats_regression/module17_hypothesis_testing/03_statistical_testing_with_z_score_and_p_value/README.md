...
> Part of **Topic 14: Hypothesis Testing** · source item type: Assignment
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-z-score-p-value/master/images/sample.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-z-score-p-value/master/images/rep_sample.png)
...
[Here is a link to an online version of z-table](http://www.z-table.com/). This lesson's GitHub repository also contains a pdf version of this table, `z-table.pdf`.
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-z-score-p-value/master/images/snorm.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-z-score-p-value/master/images/cumprob.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-z-score-p-value/master/images/cumprob2.png)
...
The table below shows three sets of Null and Alternative Hypotheses. Each makes a statement about how the mean $\mu$ is related to some hypothesized value $M$.    Set $H_0 $ $H_a$ Tails
...
![image]()
   1 $\mu= M $ $\mu \neq M $ 2   2 $\mu \geq M $ $\mu < M $ 1   3 $\mu \leq M $ $\mu > M $ 1
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-z-score-p-value/master/images/pvalue.png)
