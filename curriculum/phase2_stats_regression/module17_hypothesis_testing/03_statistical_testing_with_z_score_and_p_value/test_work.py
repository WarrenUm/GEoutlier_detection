...
def test_work_notebook_runs() -> None:
    """Statistical Testing with z-score and p-value: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Statistical Testing with z-score and p-value: the folded-in exercise notebook is a valid notebook.
