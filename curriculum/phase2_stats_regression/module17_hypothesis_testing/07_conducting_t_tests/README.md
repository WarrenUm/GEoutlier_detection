...
t-tests (also called Student’s t-test) are very practical hypothesis tests that can be employed to compare two averages (means) to assess if they are different from each other. You should run a t-test when you either: * Don’t know the population standard deviation * You have a small sample size
...
Detailed descriptions of hypothesis testing with t-tests can be found [here](http://www.mas.ncl.ac.uk/%7Enjnsm/medfac/docs/ttest) and [here](http://blog.minitab.com/blog/adventures-in-statistics-2/understanding-t-tests-t-values-and-t-distributions)
...
- Two-sample one-tail: $H*{a}: \mu*{1} < \mu_{2}$
- Two-sample two-tail: $H*{a}: \mu*{1} \neq \mu_{2}$
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-t-tests/master/index_files/index_12_0.png)
...
So, another way we could write the alternative hypothesis would be that $\mu > \mu*{0}$, where $\mu*{0}$ is the original population mean (100) and $\mu$ is the population mean of those who had the new training.
...
![drawing](https://raw.githubusercontent.com/learn-co-curriculum/dsc-t-tests/master/images/P05.png)
...
![drawing](https://raw.githubusercontent.com/learn-co-curriculum/dsc-t-tests/master/images/P01.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-t-tests/master/index_files/index_19_0.png)
...
![t-dist](https://raw.githubusercontent.com/learn-co-curriculum/dsc-t-tests/master/images/t-dist.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-t-tests/master/index_files/index_26_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-t-tests/master/index_files/index_28_0.png)
