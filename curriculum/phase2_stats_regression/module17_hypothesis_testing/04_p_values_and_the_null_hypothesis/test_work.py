...
def test_work_notebook_runs() -> None:
    """P-Values and the Null Hypothesis: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """P-Values and the Null Hypothesis: the folded-in exercise notebook is a valid notebook.
