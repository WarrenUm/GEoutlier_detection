...
def test_work_notebook_runs() -> None:
    """Goodhart's Law and Metric Tracking: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Goodhart's Law and Metric Tracking: the folded-in exercise notebook is a valid notebook.
