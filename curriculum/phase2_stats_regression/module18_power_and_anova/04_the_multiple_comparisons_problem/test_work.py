...
def test_work_notebook_runs() -> None:
    """The Multiple Comparisons Problem: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """The Multiple Comparisons Problem: the folded-in exercise notebook is a valid notebook.
