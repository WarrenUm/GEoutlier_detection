...
def test_work_notebook_runs() -> None:
    """Statistical Power and ANOVA -  Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Statistical Power and ANOVA -  Introduction: the folded-in exercise notebook is a valid notebook.
