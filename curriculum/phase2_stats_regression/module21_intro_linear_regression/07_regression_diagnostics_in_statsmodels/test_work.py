...
def test_work_notebook_runs() -> None:
    """Regression Diagnostics in Statsmodels: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Regression Diagnostics in Statsmodels: the folded-in exercise notebook is a valid notebook.
