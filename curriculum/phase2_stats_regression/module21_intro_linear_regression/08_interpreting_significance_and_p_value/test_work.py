...
def test_work_notebook_runs() -> None:
    """Interpreting Significance and P-value: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Interpreting Significance and P-value: the folded-in exercise notebook is a valid notebook.
