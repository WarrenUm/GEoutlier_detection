...
def test_work_notebook_runs() -> None:
    """Assumptions for Linear Regression: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Assumptions for Linear Regression: the folded-in exercise notebook is a valid notebook.
