...
def test_work_notebook_runs() -> None:
    """🎬 Video: Simple Linear Regression: Part 2: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: Simple Linear Regression: Part 2: the folded-in exercise notebook is a valid notebook.
