...
def test_work_notebook_runs() -> None:
    """Ordinary Least Squares in Statsmodels (OLS): the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Ordinary Least Squares in Statsmodels (OLS): the folded-in exercise notebook is a valid notebook.
