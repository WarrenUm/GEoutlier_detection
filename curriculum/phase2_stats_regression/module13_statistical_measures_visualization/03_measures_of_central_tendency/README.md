...
You will be able to: * Compare the different measures of central tendency
...
The mean value, shown as $\bar{x}$ (x-bar) for a vector $X$ is achieved by adding together all values of $X$ (shown as $\sum{X}$), and dividing $N$ (number of observations). e.g. Let’s look at a very simple set of data representing the retirement age of 11 individuals ` 54, 54, 54, 55, 56, 57, 57, 58, 58, 60, 60 `

The mean value is calculated as: 1. Adding together all the values ` 54+54+54+55+56+57+57+58+58+60+60 = 623 ` 2. Dividing by the numbers of observations ` 623/11 = 56.6 `
...
If the number of data points is even then the median is the average (mean) of the two middle items. Let's look at this dataset for the average weight of 10 individuals: ` 55, 56, 56, 58, 60, 61, 63, 64, 70, 78 `

So here, for the even number of observations (i.e. 10), the median would be calculated as: ` Median = (60 + 61)/2 = 60.5 `
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-measures-of-central-tendency/master/index_files/index_1_0.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-measures-of-central-tendency/master/images/image_sym.png)

### Skewed Distributions

A non-symmetrical distribution is called a "skewed distribution". For skewed distribution, the mode and median remain unchanged, but the mean generally moves in the direction of the tails. For such distributions, the median is often a preferred measure of central tendency, as the mean does not clearly reflect the central tendency. Based on the direction of mean's movement, such distributions can be further categorized as positively or negatively skewed distributions as shown below:

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-measures-of-central-tendency/master/images/image_pos.png)

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-measures-of-central-tendency/master/images/image_neg.png)
