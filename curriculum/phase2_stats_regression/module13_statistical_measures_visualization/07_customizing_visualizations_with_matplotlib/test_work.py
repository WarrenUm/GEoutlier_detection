...
def test_work_notebook_runs() -> None:
    """Customizing Visualizations with Matplotlib: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Customizing Visualizations with Matplotlib: the folded-in exercise notebook is a valid notebook.
