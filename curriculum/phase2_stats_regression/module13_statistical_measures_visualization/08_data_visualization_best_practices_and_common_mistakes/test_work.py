...
def test_work_notebook_runs() -> None:
    """Data Visualization - Best Practices and Common Mistakes: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Data Visualization - Best Practices and Common Mistakes: the folded-in exercise notebook is a valid notebook.
