...
> Part of **Statistical Measures** · source item type: WikiPage
...
This is the *second paragraph* on the page. What does this tell us? Pie charts are such a bad choice for data visualizations that it's own Wikipedia page starts with a warning against using them!
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-data-viz-best-practices-common-mistakes/master/images/bad_data_viz.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-data-viz-best-practices-common-mistakes/master/images/piechart.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-data-viz-best-practices-common-mistakes/master/images/new_percentages.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-data-viz-best-practices-common-mistakes/master/images/new_bad-time-series.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-data-viz-best-practices-common-mistakes/master/images/new_gun-deaths-in-FL.png)

In this visualization, the author broke the common convention of having a line go up as a number goes up. Instead, the line goes down as the number of gun deaths in Florida increases. However, most people that view this visualization leave with the exact opposite impression, because they are paying more attention to the direction of the line than they are to the numbers on the y-axis. That's because we focus on ***Preattentive Attributes*** first!

## Do: Use Preattentive Attributes

***Preattentive Attributes*** are things that our eyes are drawn to. We can't help but notice them, because our brains are wired to. There will be times when you need a visualization to communicate a specific piece of information, that you want to make as obvious as possible. The best way to do this is to pick the right preattentive attribute to highlight this!

Take a look at some of the examples in the chart below:

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-data-viz-best-practices-common-mistakes/master/images/new_preattentive-attributes.png)
...
The final mistake we'll cover today is the use of 3D Visualizations. While they may seem like a cool idea, in practice, they are almost always trouble. The reason for this is because they easily cause ***Occlusion***, which is just a fancy way of saying that the things in front block the things in back so that you can't see them! For example:

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-data-viz-best-practices-common-mistakes/master/images/new_occlusion.png)
