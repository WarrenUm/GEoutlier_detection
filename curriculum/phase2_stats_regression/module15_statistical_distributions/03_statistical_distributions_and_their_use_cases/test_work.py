...
def test_work_notebook_runs() -> None:
    """Statistical Distributions and Their Use Cases: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Statistical Distributions and Their Use Cases: the folded-in exercise notebook is a valid notebook.
