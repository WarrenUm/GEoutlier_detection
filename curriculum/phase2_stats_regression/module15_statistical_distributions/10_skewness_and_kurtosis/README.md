...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-skewness-and-kurtosis/master/images/retirement.png)
...
For univariate data $Y*1, Y*2, ..., Y_n$ the formula for skewness is:

$$\dfrac{\dfrac{\displaystyle\sum^n*{i=1}(Y*i-Y)^3}{n}}{s^3}$$
...
For univariate data $Y*1, Y*2, \dots, Y_n$ the formula for kurtosis is:

$$\dfrac{\dfrac{\displaystyle\sum^n*{i=1}(Y*i-Y)^4}{n}}{s^4}$$
