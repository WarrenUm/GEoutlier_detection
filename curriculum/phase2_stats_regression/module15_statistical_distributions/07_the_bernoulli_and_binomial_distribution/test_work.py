...
def test_work_notebook_runs() -> None:
    """The Bernoulli and Binomial Distribution: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """The Bernoulli and Binomial Distribution: the folded-in exercise notebook is a valid notebook.
