...
def test_work_notebook_runs() -> None:
    """🎬 Video: Statistical Distributions: Density Functions: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: Statistical Distributions: Density Functions: the folded-in exercise notebook is a valid notebook.
