...
def test_work_notebook_runs() -> None:
    """The Probability Mass Function: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """The Probability Mass Function: the folded-in exercise notebook is a valid notebook.
