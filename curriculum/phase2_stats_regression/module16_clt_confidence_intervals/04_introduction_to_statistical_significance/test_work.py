...
def test_work_notebook_runs() -> None:
    """Introduction to Statistical Significance: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Introduction to Statistical Significance: the folded-in exercise notebook is a valid notebook.
