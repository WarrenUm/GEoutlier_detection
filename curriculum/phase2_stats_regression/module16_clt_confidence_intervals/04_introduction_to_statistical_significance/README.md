...
You will be able to: * Understand the trade-off between correctness and utility in making statistical claims * Identify typical confidence levels, and their interpretations * Describe the connection between confidence levels and significance levels * Identify typical significance levels, and their interpretations
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-statistical-significance/master/index_files/index_7_0.png)
