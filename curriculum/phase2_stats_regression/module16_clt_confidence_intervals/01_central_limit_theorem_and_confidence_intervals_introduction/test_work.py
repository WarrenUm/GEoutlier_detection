...
def test_work_notebook_runs() -> None:
    """Central Limit Theorem and Confidence Intervals - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Central Limit Theorem and Confidence Intervals - Introduction: the folded-in exercise notebook is a valid notebook.
