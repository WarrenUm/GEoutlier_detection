...
def test_work_notebook_runs() -> None:
    """Confidence Intervals with T-Distribution: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Confidence Intervals with T-Distribution: the folded-in exercise notebook is a valid notebook.
