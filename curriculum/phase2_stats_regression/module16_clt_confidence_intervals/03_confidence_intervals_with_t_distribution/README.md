...
> Part of **Topic 13: Central Limit Theorem and Confidence Intervals** · source item type: Assignment
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-intervals-with-t-distribution/master/images/new_tdist_df.png)
...
$S=\sqrt{\dfrac{1}{n-1}\sum\limits*{i=1}^n (X*i-\bar{X})^2}$
...
We then calculate our interval estimate using a t-distribution and our various parameters. The t-distribution requires 4 parameters: * The sample mean * The sample standard deviation * The degrees of freedom (this is 1 less then the number of items in the sample) * The confidence level we wish to have in our estimate
...
[https://onlinecourses.science.psu.edu/stat414/node/199/](https://onlinecourses.science.psu.edu/stat414/node/199/%C2)
...
- `output_19_1.png` — supporting data/helper file for the exercise.
- `output_4_1.png` — supporting data/helper file for the exercise.
