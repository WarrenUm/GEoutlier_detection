...
$P(\text{small*tank | Betta*fish}) = \dfrac{P(\text{Beta*fish | small*tank})P(\text{small*tank})}{P(\text{Beta*fish})}$

Furthermore, you know:
 $P(\text{Beta*fish | small*tank}) = 1$
 $P(\text{small*tank}) = \dfrac{\text{number of fish in small tank}}{\text{number of all fish}} = \dfrac{10}{245}$
 $P(\text{Beta*fish}) = \dfrac{45}{245}$

Giving you:

$P(\text{small*tank | Betta*fish}) = \dfrac{1 \cdot \dfrac{10}{245}}{\dfrac{45}{245}}$

$ P(\text{small*tank | Betta*fish}) = \dfrac{10}{45}$
