...
def test_work_notebook_runs() -> None:
    """Maximum A Posteriori Estimation (MAP) and Multinomial Bayes: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Maximum A Posteriori Estimation (MAP) and Multinomial Bayes: the folded-in exercise notebook is a valid notebook.
