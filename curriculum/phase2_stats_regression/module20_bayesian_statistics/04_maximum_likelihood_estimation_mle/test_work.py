...
def test_work_notebook_runs() -> None:
    """Maximum Likelihood Estimation (MLE): the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Maximum Likelihood Estimation (MLE): the folded-in exercise notebook is a valid notebook.
