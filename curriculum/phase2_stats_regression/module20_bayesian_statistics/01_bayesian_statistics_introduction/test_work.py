...
def test_work_notebook_runs() -> None:
    """Bayesian Statistics - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Bayesian Statistics - Introduction: the folded-in exercise notebook is a valid notebook.
