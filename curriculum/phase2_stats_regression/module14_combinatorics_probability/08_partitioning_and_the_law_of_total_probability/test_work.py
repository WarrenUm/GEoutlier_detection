...
def test_work_notebook_runs() -> None:
    """Partitioning and the Law of Total Probability: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Partitioning and the Law of Total Probability: the folded-in exercise notebook is a valid notebook.
