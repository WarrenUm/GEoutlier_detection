...
def test_work_notebook_runs() -> None:
    """Combinatorics and Probability - Recap: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Combinatorics and Probability - Recap: the folded-in exercise notebook is a valid notebook.
