...
def test_work_notebook_runs() -> None:
    """Extension to Linear Models - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Extension to Linear Models - Introduction: the folded-in exercise notebook is a valid notebook.
