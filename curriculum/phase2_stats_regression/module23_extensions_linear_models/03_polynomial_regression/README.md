...
yld.head()
```
   .dataframe tbody tr th:only-of-type { vertical-align: middle; } .dataframe tbody tr th { vertical-align: top; } .dataframe thead th { text-align: right; }      Temp Yield   i       1 50 3.3   2 50 2.8   3 50 2.9   4 50 3.2   5 60 2.7

We will now seperate the DataFrame into the predictor and outcome variables, `X` and `y`. We do so by:
 - Assigning the `'Yield'` column to `y` - Dropping the `'Yield'` column from the `yld` DataFrame to create `X`
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-polynomial-regression/master/index_files/index_10_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-polynomial-regression/master/index_files/index_13_0.png)
...
$\hat y = \hat \beta*0 + \hat \beta*1x + \hat \beta_2 x^2$
...
X.head()
```
   .dataframe tbody tr th:only-of-type { vertical-align: middle; } .dataframe tbody tr th { vertical-align: top; } .dataframe thead th { text-align: right; }      Temp Temp_sq   i       1 50 2500   2 50 2500   3 50 2500   4 50 2500   5 60 3600
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-polynomial-regression/master/index_files/index_21_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-polynomial-regression/master/index_files/index_26_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-polynomial-regression/master/index_files/index_35_0.png)
...
- `sample_data.csv` — supporting data/helper file for the exercise.
- `yield.csv` — supporting data/helper file for the exercise.
