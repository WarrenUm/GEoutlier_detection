...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-bias-variance-trade-off/master/index_files/index_7_1.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-bias-variance-trade-off/master/index_files/index_12_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-bias-variance-trade-off/master/index_files/index_16_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-bias-variance-trade-off/master/index_files/index_24_0.png)
...
Formally, this is written as: $ MSE = Bias(\hat{f}(x))^2 + Var(\hat{f}(x)) + \sigma^2$. The derivation of this result can be found on the Wikipedia page of the bias-variance trade-off, [here](https://en.wikipedia.org/wiki/Bias%E2%80%93variance_tradeoff#Derivation).

![Drawing](https://raw.githubusercontent.com/learn-co-curriculum/dsc-bias-variance-trade-off/master/./images/new_bias_variance.png)
...
- `movie_data_detailed_with_ols.xlsx` — supporting data/helper file for the exercise.
- `yield2.csv` — supporting data/helper file for the exercise.
