...
def test_work_notebook_runs() -> None:
    """🎬 Video: Feature Selection and Engineering: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: Feature Selection and Engineering: the folded-in exercise notebook is a valid notebook.
