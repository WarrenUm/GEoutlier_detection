...
def test_work_notebook_runs() -> None:
    """HTTP Request/Response Cycle - Codealong: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """HTTP Request/Response Cycle - Codealong: the folded-in exercise notebook is a valid notebook.
