...
def test_work_notebook_runs() -> None:
    """Separating Content and Presentation: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Separating Content and Presentation: the folded-in exercise notebook is a valid notebook.
