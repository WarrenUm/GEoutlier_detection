...
def test_work_notebook_runs() -> None:
    """An Introduction to Web Scraping and Beautiful Soup: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """An Introduction to Web Scraping and Beautiful Soup: the folded-in exercise notebook is a valid notebook.
