...
def test_work_notebook_runs() -> None:
    """HTML, CSS and Web Scraping - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """HTML, CSS and Web Scraping - Introduction: the folded-in exercise notebook is a valid notebook.
