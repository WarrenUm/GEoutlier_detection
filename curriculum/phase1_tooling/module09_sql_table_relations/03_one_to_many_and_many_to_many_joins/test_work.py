...
def test_work_notebook_runs() -> None:
    """One-to-Many and Many-to-Many Joins: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """One-to-Many and Many-to-Many Joins: the folded-in exercise notebook is a valid notebook.
