...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-using-sql-with-pandas/master/images/df_example2.png)

Now, let's consider the structure of a table from a ***SQL database***.

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-using-sql-with-pandas/master/images/sql_example2.png)
...
You will be able to: * Compare accessing data in a DataFrame using query methods and conditional logic * Query DataFrames with SQL using the pandasql library
