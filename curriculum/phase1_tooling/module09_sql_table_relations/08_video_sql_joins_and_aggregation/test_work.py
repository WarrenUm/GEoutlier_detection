...
def test_work_notebook_runs() -> None:
    """🎬 Video: SQL Joins and Aggregation: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: SQL Joins and Aggregation: the folded-in exercise notebook is a valid notebook.
