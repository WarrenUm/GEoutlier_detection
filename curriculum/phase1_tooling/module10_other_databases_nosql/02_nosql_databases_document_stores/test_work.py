...
def test_work_notebook_runs() -> None:
    """NoSQL Databases: Document Stores: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """NoSQL Databases: Document Stores: the folded-in exercise notebook is a valid notebook.
