...
def test_work_notebook_runs() -> None:
    """🎬 Video: Data Analysis with JSON Files: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: Data Analysis with JSON Files: the folded-in exercise notebook is a valid notebook.
