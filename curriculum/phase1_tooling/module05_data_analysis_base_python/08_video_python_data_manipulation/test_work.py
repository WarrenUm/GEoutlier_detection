...
def test_work_notebook_runs() -> None:
    """🎬 Video: Python Data Manipulation: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: Python Data Manipulation: the folded-in exercise notebook is a valid notebook.
