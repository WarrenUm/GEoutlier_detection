...
def test_work_notebook_runs() -> None:
    """Data Analysis in Base Python - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Data Analysis in Base Python - Introduction: the folded-in exercise notebook is a valid notebook.
