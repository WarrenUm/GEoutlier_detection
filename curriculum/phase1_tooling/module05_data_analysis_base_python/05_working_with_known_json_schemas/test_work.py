...
def test_work_notebook_runs() -> None:
    """Working with Known JSON Schemas: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Working with Known JSON Schemas: the folded-in exercise notebook is a valid notebook.
