...
def test_work_notebook_runs() -> None:
    """🎬 Video: Aggregating and Combining DataFrames: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: Aggregating and Combining DataFrames: the folded-in exercise notebook is a valid notebook.
