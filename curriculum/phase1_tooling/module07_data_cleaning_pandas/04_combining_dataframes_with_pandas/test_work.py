...
def test_work_notebook_runs() -> None:
    """Combining DataFrames With Pandas: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Combining DataFrames With Pandas: the folded-in exercise notebook is a valid notebook.
