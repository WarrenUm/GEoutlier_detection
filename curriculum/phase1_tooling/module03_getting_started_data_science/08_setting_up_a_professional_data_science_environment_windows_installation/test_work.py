...
def test_work_notebook_runs() -> None:
    """Setting up a Professional Data Science Environment - Windows Installation: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Setting up a Professional Data Science Environment - Windows Installation: the folded-in exercise notebook is a valid notebook.
