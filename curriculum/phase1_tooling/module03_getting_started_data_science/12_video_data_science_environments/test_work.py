...
def test_work_notebook_runs() -> None:
    """🎬 Video: Data Science Environments: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: Data Science Environments: the folded-in exercise notebook is a valid notebook.
