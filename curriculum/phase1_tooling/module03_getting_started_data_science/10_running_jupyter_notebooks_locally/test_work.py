...
def test_work_notebook_runs() -> None:
    """Running Jupyter Notebooks Locally: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Running Jupyter Notebooks Locally: the folded-in exercise notebook is a valid notebook.
