...
def test_work_notebook_runs() -> None:
    """Getting Started with Data Science - Recap: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Getting Started with Data Science - Recap: the folded-in exercise notebook is a valid notebook.
