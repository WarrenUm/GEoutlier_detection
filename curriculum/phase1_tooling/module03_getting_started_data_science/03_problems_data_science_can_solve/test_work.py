...
def test_work_notebook_runs() -> None:
    """Problems Data Science Can Solve: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Problems Data Science Can Solve: the folded-in exercise notebook is a valid notebook.
