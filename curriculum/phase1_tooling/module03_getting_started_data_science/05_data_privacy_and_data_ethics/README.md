...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-data-ethics/master/images/fix-it.png)
...
- Android should let users [deny and revoke apps' Internet permissions](https://fixitalready.eff.org/android).
- Apple should let users [encrypt their iCloud backups](https://fixitalready.eff.org/apple).
- Facebook should [leave your phone number where you put it](https://fixitalready.eff.org/facebook).
- Slack should give [free workspace administrators control over data retention](https://fixitalready.eff.org/slack).
- Twitter should [end-to-end encrypt direct messages](https://fixitalready.eff.org/twitter).
- Venmo should let users [hide their friends lists](https://fixitalready.eff.org/venmo).
- Verizon should [stop pre-installing spyware on its users’ phones](https://fixitalready.eff.org/verizon).
- WhatsApp should [get your consent before you’re added to a group](https://fixitalready.eff.org/whatsapp).
- Windows 10 should let users [keep their disk encryption keys to themselves](https://fixitalready.eff.org/win10).
