...
def test_work_notebook_runs() -> None:
    """While Loops, Break and Continue: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """While Loops, Break and Continue: the folded-in exercise notebook is a valid notebook.
