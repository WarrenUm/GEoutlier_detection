...
def test_work_notebook_runs() -> None:
    """User Input and Output in Python: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """User Input and Output in Python: the folded-in exercise notebook is a valid notebook.
