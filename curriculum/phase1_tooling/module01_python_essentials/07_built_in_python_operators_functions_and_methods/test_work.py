...
def test_work_notebook_runs() -> None:
    """Built-in Python Operators, Functions and Methods: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Built-in Python Operators, Functions and Methods: the folded-in exercise notebook is a valid notebook.
