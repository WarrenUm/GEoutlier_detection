...
def test_work_notebook_runs() -> None:
    """Collaborating with Git Branches: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Collaborating with Git Branches: the folded-in exercise notebook is a valid notebook.
