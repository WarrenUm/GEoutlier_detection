...
- Then create a subfolder titled "Section1", "Bash*and*Git" (or whatever you find to be an appropriate title) and navigate into that
- Return to your web browser and navigate to the lesson you want to download
- Click the GitHub icon

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-git-intro/master/images/learn_github_logo.png)

You'll be redirected to the associated github repository like this.

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-git-intro/master/images/github_fork_button.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-git-intro/master/images/github_forking_in_progress.png)

You'll be redirected to your new personal copy of the repository:

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-git-intro/master/images/forked_github_page.png)
...
View [Enough Git for Learn](https://learn.co/lessons/enough-git-for-learn-co) on Learn.co and start learning to code for free
