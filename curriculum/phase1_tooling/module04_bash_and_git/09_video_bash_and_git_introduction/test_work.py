...
def test_work_notebook_runs() -> None:
    """🎬 Video: Bash and Git Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """🎬 Video: Bash and Git Introduction: the folded-in exercise notebook is a valid notebook.
