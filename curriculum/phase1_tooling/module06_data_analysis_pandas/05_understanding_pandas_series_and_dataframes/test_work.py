...
def test_work_notebook_runs() -> None:
    """Understanding Pandas Series and DataFrames: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Understanding Pandas Series and DataFrames: the folded-in exercise notebook is a valid notebook.
