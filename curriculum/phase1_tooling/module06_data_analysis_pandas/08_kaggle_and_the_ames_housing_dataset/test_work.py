...
def test_work_notebook_runs() -> None:
    """Kaggle and The Ames Housing Dataset: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Kaggle and The Ames Housing Dataset: the folded-in exercise notebook is a valid notebook.
