...
def test_work_notebook_runs() -> None:
    """Data Visualization with Pandas: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Data Visualization with Pandas: the folded-in exercise notebook is a valid notebook.
