...
def test_work_notebook_runs() -> None:
    """Refactoring Your Code to Use Pipelines: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Refactoring Your Code to Use Pipelines: the folded-in exercise notebook is a valid notebook.
