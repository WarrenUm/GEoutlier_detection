...
def test_work_notebook_runs() -> None:
    """Scalars, Vectors, Matrices, and Tensors - Code Along: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Scalars, Vectors, Matrices, and Tensors - Code Along: the folded-in exercise notebook is a valid notebook.
