...
def test_work_notebook_runs() -> None:
    """Matrix Multiplication - Code Along: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Matrix Multiplication - Code Along: the folded-in exercise notebook is a valid notebook.
