...
def test_work_notebook_runs() -> None:
    """Solving Systems of Linear Equations with NumPy - Code Along: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Solving Systems of Linear Equations with NumPy - Code Along: the folded-in exercise notebook is a valid notebook.
