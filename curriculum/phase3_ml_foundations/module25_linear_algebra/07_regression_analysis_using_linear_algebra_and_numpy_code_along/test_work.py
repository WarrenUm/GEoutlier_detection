...
def test_work_notebook_runs() -> None:
    """Regression Analysis using Linear Algebra and NumPy - Code Along: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Regression Analysis using Linear Algebra and NumPy - Code Along: the folded-in exercise notebook is a valid notebook.
