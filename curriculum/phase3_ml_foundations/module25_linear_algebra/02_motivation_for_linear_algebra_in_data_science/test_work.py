...
def test_work_notebook_runs() -> None:
    """Motivation for Linear Algebra in Data Science: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Motivation for Linear Algebra in Data Science: the folded-in exercise notebook is a valid notebook.
