...
def test_work_notebook_runs() -> None:
    """Building Trees using scikit-learn: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Building Trees using scikit-learn: the folded-in exercise notebook is a valid notebook.
