...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-entropy-and-information-gain/master/images/split_fs.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-entropy-and-information-gain/master/images/new_entropy_fs.png)
...
$$Information~Gain = Entropy*{parent} - Entropy*{child}.[child ~weighted ~average]$$
...
Our dataset is as follows:   outlook temp humidity windy play    overcast cool high Y yes   overcast mild normal N yes   sunny cool normal N yes   overcast hot high Y no   sunny hot normal Y yes   rain mild high N no   rain cool normal N no   sunny mild high N yes   sunny cool normal Y yes   sunny mild normal Y yes   overcast cool high N yes   rain cool high Y no   sunny hot normal Y no   sunny mild high N yes
...
$$\large p(yes) = -(9/14)log*2(9/14) = 0.28$$ $$\large p(no) = -(5/14)log*2(5/14) = 0.37$$ $$\large H(S) = p(yes) + p(no) = 0.65$$
