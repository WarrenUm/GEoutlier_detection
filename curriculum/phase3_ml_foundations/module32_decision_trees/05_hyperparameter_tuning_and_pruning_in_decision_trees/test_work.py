...
def test_work_notebook_runs() -> None:
    """Hyperparameter Tuning and Pruning in Decision Trees: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Hyperparameter Tuning and Pruning in Decision Trees: the folded-in exercise notebook is a valid notebook.
