...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-tuning-decision-trees/master/images/depth.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-tuning-decision-trees/master/images/split.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-tuning-decision-trees/master/images/leaf.png)
...
- `features.csv` — supporting data/helper file for the exercise.
- `gender_submission.csv` — supporting data/helper file for the exercise.
- `target.csv` — supporting data/helper file for the exercise.
- `test.csv` — supporting data/helper file for the exercise.
- `titanic.csv` — supporting data/helper file for the exercise.
- `train.csv` — supporting data/helper file for the exercise.
