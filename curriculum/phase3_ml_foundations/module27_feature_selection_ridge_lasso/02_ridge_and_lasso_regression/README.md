...
$$ \text{cost*function}= \sum*{i=1}^n(y*i - \hat{y})^2 = \sum*{i=1}^n(y*i - (mx*i + b))^2$$
...
$$ \text{cost*function}= \sum*{i=1}^n(y*i - \hat{y})^2 = \sum*{i=1}^n(y*i - \sum*{j=1}^k(m*jx*{ij} ) -b )^2$$
...
$$ \text{cost*function*ridge}= \sum*{i=1}^n(y*i - \hat{y})^2 = $$

$$ \sum*{i=1}^n(y*i - ((m*1x*{1i})-b)^2 + \lambda m*1^2 + (m*2x*{2i})-b)^2 + \lambda m*2^2)$$
...
$$ \text{cost*function*lasso}= \sum*{i=1}^n(y*i - \hat{y})^2 = $$

$$\sum*{i=1}^n(y*i - ((m*1x*{1i})-b)^2 + \lambda \mid m*1 \mid) + ((m*2x*{2i})-b)^2 + \lambda \mid m*2 \mid) $$
