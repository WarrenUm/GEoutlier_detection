...
def test_work_notebook_runs() -> None:
    """Feature and Model Selection: AIC and BIC: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Feature and Model Selection: AIC and BIC: the folded-in exercise notebook is a valid notebook.
