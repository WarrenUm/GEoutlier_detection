...
def test_work_notebook_runs() -> None:
    """Bayesian Classification - Recap: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Bayesian Classification - Recap: the folded-in exercise notebook is a valid notebook.
