...
def test_work_notebook_runs() -> None:
    """Bayesian Classification - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Bayesian Classification - Introduction: the folded-in exercise notebook is a valid notebook.
