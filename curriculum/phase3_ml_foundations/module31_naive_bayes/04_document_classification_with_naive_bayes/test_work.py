...
def test_work_notebook_runs() -> None:
    """Document Classification with Naive Bayes: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Document Classification with Naive Bayes: the folded-in exercise notebook is a valid notebook.
