...
def test_work_notebook_runs() -> None:
    """Derivatives of Non-Linear Functions: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Derivatives of Non-Linear Functions: the folded-in exercise notebook is a valid notebook.
