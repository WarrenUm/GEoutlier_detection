...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-derivatives-of-non-linear-functions/master/index_files/index_6_0.png)

Where our function was given by $f(x)=6x$. We saw multiple ways of calculating the derivative: * Essentially, the derivative is the rate of change of a function * Graphically this is rise over run * Which can be calculated by taking two points, $(x*1, y*1)$ and $(x*2, y*2)$ and calculating $\frac{y*2 - y*1}{x*2 - x*1}$
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-derivatives-of-non-linear-functions/master/index_files/index_12_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-derivatives-of-non-linear-functions/master/index_files/index_14_0.png)
...
we do the following: * Set $x = 2$, as that's the point we want to calculate the rate of change at * Set $\Delta x = 1$, as that's the number of seconds that elapsed on our stopwatch
...
- in our formula of $ f'(x) = \dfrac{f(x + \Delta x) - f(x)}{\Delta x} $, we are seeing the rate of change not just where $x = 2$, but from the period from $x = 2$ to $x = 3$. Recall that the derivative is supposed to be the **instantaneous** rate of change! However, it seems that this interval does not reflect the **instantaneous** nature!
...
In this example, by decreasing $\Delta x$ we can see a fairly clear pattern.   $ \Delta x $ $ \frac{\Delta y}{\Delta x} $    1 5   .1 4.1   .01 4.01   .001 4.001
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-derivatives-of-non-linear-functions/master/index_files/index_30_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-derivatives-of-non-linear-functions/master/index_files/index_33_0.png)
...
- `calculus.py` — supporting data/helper file for the exercise.
