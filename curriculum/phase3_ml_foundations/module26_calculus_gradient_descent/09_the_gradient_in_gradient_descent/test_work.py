...
def test_work_notebook_runs() -> None:
    """The Gradient in Gradient Descent: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """The Gradient in Gradient Descent: the folded-in exercise notebook is a valid notebook.
