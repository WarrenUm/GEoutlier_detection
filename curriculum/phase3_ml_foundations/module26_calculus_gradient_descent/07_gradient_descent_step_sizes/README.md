...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-gradient-descent-step-sizes/master/index_files/index_3_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-gradient-descent-step-sizes/master/index_files/index_5_0.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-gradient-descent-step-sizes/master/./images/new_gradientdescent.png)
...
Remember in the last lesson, we evaluated our regression line by changing our slope by 1 to determine whether it produced a higher or lower RSS.    m residual sum of squared    44 1053.31   45 870.75   46 711.05   47 574.3   48 460.37   49 369.35   50 301.17   51 255.89   52 233.49   53 234   54 257.35   55 303.64   56 372.74
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-gradient-descent-step-sizes/master/./images/snowboard.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-gradient-descent-step-sizes/master/index_files/index_24_0.png)
...
We use the following procedure to find the ideal $m$: 1. Randomly choose a value of $m$, and 2. Update $m$ with the formula $ m = (-.02) * slope*{m = i} + m*i$.
