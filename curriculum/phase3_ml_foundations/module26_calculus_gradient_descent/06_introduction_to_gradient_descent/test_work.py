...
def test_work_notebook_runs() -> None:
    """Introduction to Gradient Descent: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Introduction to Gradient Descent: the folded-in exercise notebook is a valid notebook.
