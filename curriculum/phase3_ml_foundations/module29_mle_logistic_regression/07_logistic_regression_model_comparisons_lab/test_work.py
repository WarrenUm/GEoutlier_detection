...
def test_work_notebook_runs() -> None:
    """Logistic Regression Model Comparisons - Lab: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Logistic Regression Model Comparisons - Lab: the folded-in exercise notebook is a valid notebook.
