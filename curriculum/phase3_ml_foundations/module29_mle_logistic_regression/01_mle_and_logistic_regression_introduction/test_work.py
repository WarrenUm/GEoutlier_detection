...
def test_work_notebook_runs() -> None:
    """MLE and Logistic Regression - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """MLE and Logistic Regression - Introduction: the folded-in exercise notebook is a valid notebook.
