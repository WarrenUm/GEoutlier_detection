...
def test_work_notebook_runs() -> None:
    """Coding Logistic Regression from Scratch - Lab: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Coding Logistic Regression from Scratch - Lab: the folded-in exercise notebook is a valid notebook.
