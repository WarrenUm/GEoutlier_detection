...
def test_work_notebook_runs() -> None:
    """K-Nearest Neighbors - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """K-Nearest Neighbors - Introduction: the folded-in exercise notebook is a valid notebook.
