...
def test_work_notebook_runs() -> None:
    """Gradient Boosting and Weak Learners: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Gradient Boosting and Weak Learners: the folded-in exercise notebook is a valid notebook.
