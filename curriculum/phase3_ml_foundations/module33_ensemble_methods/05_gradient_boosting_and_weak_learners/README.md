...
There are two main algorithms that come to mind when Data Scientists talk about boosting: ***Adaboost*** (short for Adaptive Boosting), and ***Gradient Boosted Trees***. Both are generally very effective, but they use different methods to achieve their results.
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-gradient-boosting-and-weak-learners/master/images/new_adaboost.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-gradient-boosting-and-weak-learners/master/images/new_gradient-boosting.png)
...
- `pima-indians-diabetes.csv` — supporting data/helper file for the exercise.
