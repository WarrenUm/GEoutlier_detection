...
def test_work_notebook_runs() -> None:
    """Linear to Logistic Regression: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Linear to Logistic Regression: the folded-in exercise notebook is a valid notebook.
