...
> Part of **Topic 21: Object-Oriented Programming** · source item type: Assignment
...
- `driver.py` — supporting data/helper file for the exercise.
- `passenger.py` — supporting data/helper file for the exercise.
- `requirements.txt` — supporting data/helper file for the exercise.
- `ride.py` — supporting data/helper file for the exercise.
