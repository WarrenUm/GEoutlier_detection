...
def test_work_notebook_runs() -> None:
    """Market Segmentation with Clustering: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Market Segmentation with Clustering: the folded-in exercise notebook is a valid notebook.
