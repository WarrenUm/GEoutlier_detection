...
def test_work_notebook_runs() -> None:
    """Semi-Supervised Learning and Look-Alike Models: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Semi-Supervised Learning and Look-Alike Models: the folded-in exercise notebook is a valid notebook.
