...
def test_work_notebook_runs() -> None:
    """Common Problems with Clustering Algorithms: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Common Problems with Clustering Algorithms: the folded-in exercise notebook is a valid notebook.
