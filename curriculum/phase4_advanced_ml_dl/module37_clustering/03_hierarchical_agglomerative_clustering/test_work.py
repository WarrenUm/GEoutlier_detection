...
def test_work_notebook_runs() -> None:
    """Hierarchical Agglomerative Clustering: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Hierarchical Agglomerative Clustering: the folded-in exercise notebook is a valid notebook.
