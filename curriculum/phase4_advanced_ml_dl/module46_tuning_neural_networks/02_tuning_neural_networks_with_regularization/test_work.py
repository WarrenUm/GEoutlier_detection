...
def test_work_notebook_runs() -> None:
    """Tuning Neural Networks with Regularization: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Tuning Neural Networks with Regularization: the folded-in exercise notebook is a valid notebook.
