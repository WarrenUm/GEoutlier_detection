...
def test_work_notebook_runs() -> None:
    """Context-Free Grammars and POS Tagging: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Context-Free Grammars and POS Tagging: the folded-in exercise notebook is a valid notebook.
