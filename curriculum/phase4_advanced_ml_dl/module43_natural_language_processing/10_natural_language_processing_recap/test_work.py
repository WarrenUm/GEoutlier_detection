...
def test_work_notebook_runs() -> None:
    """Natural Language Processing - Recap: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Natural Language Processing - Recap: the folded-in exercise notebook is a valid notebook.
