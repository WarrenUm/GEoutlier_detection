...
def test_work_notebook_runs() -> None:
    """Feature Engineering for Text Data: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Feature Engineering for Text Data: the folded-in exercise notebook is a valid notebook.
