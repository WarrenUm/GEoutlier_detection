...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-regular-expressions-codealong/master/images/regex_cheat_sheet.png)
...
- `menu.txt` — supporting data/helper file for the exercise.
