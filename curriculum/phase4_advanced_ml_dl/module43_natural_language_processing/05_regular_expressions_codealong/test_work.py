...
def test_work_notebook_runs() -> None:
    """Regular Expressions - Codealong: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Regular Expressions - Codealong: the folded-in exercise notebook is a valid notebook.
