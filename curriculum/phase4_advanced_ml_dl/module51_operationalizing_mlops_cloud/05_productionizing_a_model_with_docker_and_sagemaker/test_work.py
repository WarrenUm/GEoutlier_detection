...
def test_work_notebook_runs() -> None:
    """Productionizing a Model with Docker and SageMaker: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Productionizing a Model with Docker and SageMaker: the folded-in exercise notebook is a valid notebook.
