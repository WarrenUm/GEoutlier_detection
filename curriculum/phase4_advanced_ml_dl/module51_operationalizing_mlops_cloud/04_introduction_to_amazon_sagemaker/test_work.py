...
def test_work_notebook_runs() -> None:
    """Introduction to Amazon SageMaker: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Introduction to Amazon SageMaker: the folded-in exercise notebook is a valid notebook.
