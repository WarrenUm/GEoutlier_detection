...
def test_work_notebook_runs() -> None:
    """Data Science and Machine Learning Engineering: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Data Science and Machine Learning Engineering: the folded-in exercise notebook is a valid notebook.
