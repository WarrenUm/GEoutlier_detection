...
def test_work_notebook_runs() -> None:
    """Parallel and Distributed Computing with MapReduce: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Parallel and Distributed Computing with MapReduce: the folded-in exercise notebook is a valid notebook.
