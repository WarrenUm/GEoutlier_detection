...
def test_work_notebook_runs() -> None:
    """Installing and Configuring PySpark with Docker: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Installing and Configuring PySpark with Docker: the folded-in exercise notebook is a valid notebook.
