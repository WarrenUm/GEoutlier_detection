...
> Part of **Topic 35: Big Data in PySpark** · source item type: Assignment
...
- Download & install Docker on Mac : [https://download.docker.com/mac/stable/Docker.dmg](https://download.docker.com/mac/stable/Docker.dmg)
- Download and install Docker on Windows: [https://hub.docker.com/editions/community/docker-ce-desktop-windows](https://hub.docker.com/editions/community/docker-ce-desktop-windows)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-spark-docker-installation/master/./images/kite.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-spark-docker-installation/master/./images/hub.png)
...
If everything went fine, you should see an output like this: ` [941, 60, 987, 542, 718] `
...
Once this command has been executed, you can go through the same process as above to input the token into your browser after going to [http://localhost:8888](http://localhost:8888). After doing so, navigate to the folder "work" and execute the cell below.
