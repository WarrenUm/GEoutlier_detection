...
def test_work_notebook_runs() -> None:
    """Big Data Analytics on Apache Spark: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Big Data Analytics on Apache Spark: the folded-in exercise notebook is a valid notebook.
