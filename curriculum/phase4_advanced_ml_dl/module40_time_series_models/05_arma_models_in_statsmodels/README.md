...
$$Y*t = \mu + \phi * Y*{t-1}+\epsilon_t$$

This means that:

$$Y*1 = \mu + \phi * Y*{0}+\epsilon*1$$ $$Y*2 = \mu + \phi * (\text{mean-centered version of } Y*1) +\epsilon*2$$
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-arma-models-statsmodels/master/index_files/index_8_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-arma-models-statsmodels/master/index_files/index_11_0.png)

![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-arma-models-statsmodels/master/index_files/index_11_1.png)
...
$$Y*t = \mu +\epsilon*t + \theta * \epsilon_{t-1}$$

This means that:

$$Y*1 = \mu + \epsilon*1+ \theta * \epsilon*{0}$$ $$Y*2 = \mu + \epsilon*2+ \theta * \epsilon*{1}$$
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-arma-models-statsmodels/master/index_files/index_23_0.png)
...
![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-arma-models-statsmodels/master/index_files/index_25_0.png)

![png](https://raw.githubusercontent.com/learn-co-curriculum/dsc-arma-models-statsmodels/master/index_files/index_25_1.png)
