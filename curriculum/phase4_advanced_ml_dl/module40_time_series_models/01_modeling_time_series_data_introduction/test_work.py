...
def test_work_notebook_runs() -> None:
    """Modeling Time Series Data - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Modeling Time Series Data - Introduction: the folded-in exercise notebook is a valid notebook.
