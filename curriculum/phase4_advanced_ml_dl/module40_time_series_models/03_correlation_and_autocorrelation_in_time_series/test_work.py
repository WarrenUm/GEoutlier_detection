...
def test_work_notebook_runs() -> None:
    """Correlation and Autocorrelation in Time Series: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Correlation and Autocorrelation in Time Series: the folded-in exercise notebook is a valid notebook.
