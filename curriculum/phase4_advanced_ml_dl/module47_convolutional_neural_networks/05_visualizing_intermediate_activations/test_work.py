...
def test_work_notebook_runs() -> None:
    """Visualizing Intermediate Activations: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Visualizing Intermediate Activations: the folded-in exercise notebook is a valid notebook.
