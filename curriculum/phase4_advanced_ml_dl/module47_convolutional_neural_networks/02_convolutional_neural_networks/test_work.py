...
def test_work_notebook_runs() -> None:
    """Convolutional Neural Networks: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Convolutional Neural Networks: the folded-in exercise notebook is a valid notebook.
