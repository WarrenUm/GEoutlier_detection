...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-convolutional-neural-networks/master/images/Image_158CNN.png)
...
![title](https://raw.githubusercontent.com/learn-co-curriculum/dsc-convolutional-neural-networks/master/images/conv.png)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-convolutional-neural-networks/master/images/convolution-layer-a.png)

[gif courtesy of Stanford University](https://stanford.edu/%7Eshervine/teaching/cs-230/cheatsheet-convolutional-neural-networks)
...
![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-convolutional-neural-networks/master/images/5by5_3by3_1.jpeg)

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-convolutional-neural-networks/master/images/5by5_3by3_2.jpeg)

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-convolutional-neural-networks/master/images/5by5_3by3_3.jpeg)

![image](https://raw.githubusercontent.com/learn-co-curriculum/dsc-convolutional-neural-networks/master/images/5by5_3by3_4.jpeg)
...
Input = $ n*h^{[l-1]} * n*w^{[l-1]} * n_c^{[l-1]} $
-

Output = $ n*h^{[l]} * n*w^{[l]} * n_c^{[l]} $

Height and width are given by:

$n*h^{[l]}= \Bigr\lfloor\dfrac{n*h^{[l-1]}+2p^{[l]}-f^{[l]}}{s^{[l]}}+1\Bigr\rfloor$

$n*w^{[l]}= \Bigr\lfloor\dfrac{n*w^{[l-1]}+2p^{[l]}-f^{[l]}}{s^{[l]}}+1\Bigr\rfloor$

Activations: $a^{[l]}$ is of dimension $ n*h^{[l]} * n*w^{[l]} * n_c^{[l]} $
