...
def test_work_notebook_runs() -> None:
    """PCA and Digital Image Processing: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """PCA and Digital Image Processing: the folded-in exercise notebook is a valid notebook.
