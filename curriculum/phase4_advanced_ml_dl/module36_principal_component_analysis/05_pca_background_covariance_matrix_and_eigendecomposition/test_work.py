...
def test_work_notebook_runs() -> None:
    """PCA Background: Covariance Matrix and Eigendecomposition: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """PCA Background: Covariance Matrix and Eigendecomposition: the folded-in exercise notebook is a valid notebook.
