...
def test_work_notebook_runs() -> None:
    """Performing Principal Component Analysis: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Performing Principal Component Analysis: the folded-in exercise notebook is a valid notebook.
