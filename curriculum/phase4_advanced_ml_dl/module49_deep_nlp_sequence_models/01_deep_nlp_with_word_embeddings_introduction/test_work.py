...
def test_work_notebook_runs() -> None:
    """Deep NLP with Word Embeddings - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Deep NLP with Word Embeddings - Introduction: the folded-in exercise notebook is a valid notebook.
