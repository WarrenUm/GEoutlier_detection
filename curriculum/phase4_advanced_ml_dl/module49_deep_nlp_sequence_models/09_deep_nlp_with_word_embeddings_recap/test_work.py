...
def test_work_notebook_runs() -> None:
    """Deep NLP with Word Embeddings - Recap: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Deep NLP with Word Embeddings - Recap: the folded-in exercise notebook is a valid notebook.
