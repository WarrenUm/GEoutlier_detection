...
def test_work_notebook_runs() -> None:
    """Understanding Recurrent Neural Networks: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Understanding Recurrent Neural Networks: the folded-in exercise notebook is a valid notebook.
