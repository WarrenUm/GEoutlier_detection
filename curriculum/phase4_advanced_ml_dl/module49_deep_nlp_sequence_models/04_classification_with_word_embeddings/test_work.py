...
def test_work_notebook_runs() -> None:
    """Classification with Word Embeddings: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Classification with Word Embeddings: the folded-in exercise notebook is a valid notebook.
