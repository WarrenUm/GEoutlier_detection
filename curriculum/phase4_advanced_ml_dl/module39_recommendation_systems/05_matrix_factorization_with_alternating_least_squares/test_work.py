...
def test_work_notebook_runs() -> None:
    """Matrix Factorization with Alternating Least Squares: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Matrix Factorization with Alternating Least Squares: the folded-in exercise notebook is a valid notebook.
