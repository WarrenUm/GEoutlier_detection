...
def test_work_notebook_runs() -> None:
    """Collaborative Filtering and Singular Value Decomposition: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Collaborative Filtering and Singular Value Decomposition: the folded-in exercise notebook is a valid notebook.
