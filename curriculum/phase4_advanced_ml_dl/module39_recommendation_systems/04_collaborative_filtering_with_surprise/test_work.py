...
def test_work_notebook_runs() -> None:
    """Collaborative Filtering with Surprise: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Collaborative Filtering with Surprise: the folded-in exercise notebook is a valid notebook.
