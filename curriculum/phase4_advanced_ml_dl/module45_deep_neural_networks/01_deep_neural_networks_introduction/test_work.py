...
def test_work_notebook_runs() -> None:
    """Deep Neural Networks - Introduction: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Deep Neural Networks - Introduction: the folded-in exercise notebook is a valid notebook.
