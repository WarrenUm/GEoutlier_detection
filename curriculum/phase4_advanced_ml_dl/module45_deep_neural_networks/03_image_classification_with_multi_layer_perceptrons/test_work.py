...
def test_work_notebook_runs() -> None:
    """Image Classification with Multi-Layer Perceptrons: the work notebook executes without error."""
...
def test_lab_notebook_is_valid() -> None:
    """Image Classification with Multi-Layer Perceptrons: the folded-in exercise notebook is a valid notebook.
